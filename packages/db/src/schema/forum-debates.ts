...
export const forumDebates = pgTable('forum_debates', {
...
export const forumDebateComments = pgTable('forum_debate_comments', {
  id: uuid('id').defaultRandom().primaryKey(),
...
export const forumDebateLikes = pgTable('forum_debate_likes', {
  id: uuid('id').defaultRandom().primaryKey(),
...
export const forumExpertPerformance = pgTable('forum_expert_performance', {
  id: uuid('id').defaultRandom().primaryKey(),
...
export const forumCustomExperts = pgTable('forum_custom_experts', {
  id: uuid('id').defaultRandom().primaryKey(),
...
export const forumDebateTemplates = pgTable('forum_debate_templates', {
  id: uuid('id').defaultRandom().primaryKey(),
...
export const forumDebatesRelations = relations(forumDebates, ({ one, many }) => ({
  user: one(profiles, {
    fields: [forumDebates.userId],
...
export type ForumDebate = typeof forumDebates.$inferSelect
export type NewForumDebate = typeof forumDebates.$inferInsert
