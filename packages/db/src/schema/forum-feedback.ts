...
export const forumExpertFeedback = pgTable('forum_expert_feedback', {
  ...
  userIdx: index('idx_forum_expert_feedback_user').on(table.userId),
  debateIdx: index('idx_forum_expert_feedback_debate').on(table.debateId),
  expertIdx: index('idx_forum_expert_feedback_expert').on(table.expertId),
  ratingIdx: index('idx_forum_expert_feedback_rating').on(table.rating),
}))
...
export const forumExpertRatings = pgTable('forum_expert_ratings', {
  id: uuid('id').defaultRandom().primaryKey(),
  ...
  avgRatingIdx: index('idx_forum_expert_ratings_avg').on(table.avgRating),
}))
