...
export const forumDealLinks = pgTable('quoorum_deal_links', {
  ...
  userIdx: index('idx_quoorum_deal_links_user').on(table.userId),
  debateIdx: index('idx_quoorum_deal_links_debate').on(table.debateId),
  dealIdx: index('idx_quoorum_deal_links_deal').on(table.dealId),
  contextIdx: index('idx_quoorum_deal_links_context').on(table.context),
}))
...
export const forumDealRecommendations = pgTable('quoorum_deal_recommendations', {
  id: uuid('id').defaultRandom().primaryKey(),
  ...
  userIdx: index('idx_quoorum_deal_recs_user').on(table.userId),
  dealIdx: index('idx_quoorum_deal_recs_deal').on(table.dealId),
  activeIdx: index('idx_quoorum_deal_recs_active').on(table.dealId, table.isActive),
}))
