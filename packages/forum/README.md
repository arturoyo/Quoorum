...
```typescript
import { runDebate } from '@wallie/forum/runner'
import { loadContext } from '@wallie/forum/context'
...
```typescript
export const FORUM_AGENTS: Record<AgentKey, AgentConfig> = {
  optimizer: {
    name: 'Optimista',
...
- [forum_use_cases_catalog.md](/home/ubuntu/forum_use_cases_catalog.md) - 115 casos de uso
