 ...
 * console.error is migrated to forumLogger for consistency
 */
...
async function main() {
  ...
  switch (command) {
    ...
    case 'debate': {
      ...
      if (!question) {
        forumLogger.error('Please provide a question', undefined, { command: 'create' })
    ...
    case 'export': {
      ...
      if (!exportDebateId) {
        forumLogger.error('Please provide a debate ID', undefined, { command: 'export' })
    ...
    case 'analyze': {
      ...
      if (!analyzeDebateId) {
        forumLogger.error('Please provide a debate ID', undefined, { command: 'analyze' })
    ...
    default: {
      forumLogger.error('Unknown command', undefined, { command })
...
function printHelp() {
  console.log(`
🎯 Forum CLI - Command-line interface for Forum Dynamic System
