...
export { forumLogger as logger } from './logger' // Alias para compatibilidad
...
// WebSocket Server
export { ForumWebSocketServer, getWebSocketServer, broadcastDebateUpdate } from './websocket-server'
...
export {
  ...
  // ForumSystem is the unified entry point for all orchestration features
  ForumSystem,
  createForumSystem,
  createTestForumSystem,
  // ========== LEGACY (DEPRECATED) ==========
  // Use ForumSystem instead - these will be removed in next major version
  DebateOrchestrator,
  createOrchestrator,
  runOrchestrated,
  recommendPattern,
