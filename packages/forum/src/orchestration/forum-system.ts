 ...
 */
export function createForumSystem(config: ForumSystemConfig = {}): ForumSystem {
  return new ForumSystem(config)
}

/**
 * Create Forum System with mock AI for testing
 */
export function createTestForumSystem(): ForumSystem {
  return new ForumSystem({
    teamMembers: [
