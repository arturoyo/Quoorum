...
export function getAgentsByTier(
  ...
  return {
    optimizer: {
      key: QUOORUM_AGENTS.optimizer!.key,
      name: QUOORUM_AGENTS.optimizer!.name,
      role: QUOORUM_AGENTS.optimizer!.role,
      prompt: QUOORUM_AGENTS.optimizer!.prompt,
      systemPrompt: QUOORUM_AGENTS.optimizer!.systemPrompt,
      narrativeId: QUOORUM_AGENTS.optimizer!.narrativeId,
      provider: optimizerTierConfig.provider,
      model: optimizerTierConfig.model,
      temperature: optimizerTierConfig.temperature,
    },
    critic: {
      key: QUOORUM_AGENTS.critic!.key,
      name: QUOORUM_AGENTS.critic!.name,
      role: QUOORUM_AGENTS.critic!.role,
      prompt: QUOORUM_AGENTS.critic!.prompt,
      systemPrompt: QUOORUM_AGENTS.critic!.systemPrompt,
      narrativeId: QUOORUM_AGENTS.critic!.narrativeId,
      provider: criticTierConfig.provider,
      model: criticTierConfig.model,
      temperature: criticTierConfig.temperature,
    },
    analyst: {
      key: QUOORUM_AGENTS.analyst!.key,
      name: QUOORUM_AGENTS.analyst!.name,
      role: QUOORUM_AGENTS.analyst!.role,
      prompt: QUOORUM_AGENTS.analyst!.prompt,
      systemPrompt: QUOORUM_AGENTS.analyst!.systemPrompt,
      narrativeId: QUOORUM_AGENTS.analyst!.narrativeId,
      provider: analystTierConfig.provider,
      model: analystTierConfig.model,
      temperature: analystTierConfig.temperature,
    },
    synthesizer: {
      key: QUOORUM_AGENTS.synthesizer!.key,
      name: QUOORUM_AGENTS.synthesizer!.name,
      role: QUOORUM_AGENTS.synthesizer!.role,
      prompt: QUOORUM_AGENTS.synthesizer!.prompt,
      systemPrompt: QUOORUM_AGENTS.synthesizer!.systemPrompt,
      narrativeId: QUOORUM_AGENTS.synthesizer!.narrativeId,
      provider: synthesizerTierConfig.provider,
      model: synthesizerTierConfig.model,
      temperature: synthesizerTierConfig.temperature,
    },
  }
}
