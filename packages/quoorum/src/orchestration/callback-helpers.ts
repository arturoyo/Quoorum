...
export function consoleCallbacks(): OrchestrationCallbacks {
  return {
    onStructureReady: (structure) => {
      quoorumLogger.info('Estructura lista', {
