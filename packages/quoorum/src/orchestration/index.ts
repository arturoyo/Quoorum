...
// ============================================================================
// UNIFIED API (RECOMMENDED) - Use QuoorumSystem for everything
// ============================================================================

// Forum System (Unified Integration Layer) - PRIMARY ENTRY POINT
export { QuoorumSystem, createQuoorumSystem, createTestQuoorumSystem } from './quoorum-system'
export type {
  QuoorumSystemConfig,
  DecisionConfig,
  DecisionResult,
...
// ============================================================================
// MODULES (All integrated into QuoorumSystem, but exposed for direct access)
// ============================================================================
...
// Executive Insights (used internally by QuoorumSystem)
export {
...
// Use QuoorumSystem instead for all these features
// ============================================================================

/**
 * @deprecated Use QuoorumSystem.analyzeQuestion() instead
 */
export { analyzeQuestion } from './debate-sequence'

/**
 * @deprecated Use createQuoorumSystem() and forum.runDecision() instead
 */
export { runOrchestrated } from './debate-sequence'

/**
 * @deprecated Use QuoorumSystem.recommendPattern() instead
 */
...
/**
 * @deprecated Use QuoorumSystem.setManualMode() instead
 */
export { manualModeConfig } from './debate-sequence'

/**
 * @deprecated Use QuoorumSystem.setAutoMode() instead
 */
export { autoModeConfig } from './debate-sequence'

/**
 * @deprecated Use QuoorumSystem.setCostLimits() instead
 */
export { costLimitedConfig } from './debate-sequence'

/**
 * @deprecated Use QuoorumSystem.setQualityThresholds() instead
 */
...
/**
 * @deprecated Use createQuoorumSystem() instead
 * QuoorumSystem provides all DebateOrchestrator features plus:
...
/**
 * @deprecated Use QuoorumSystem methods instead:
