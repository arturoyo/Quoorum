...
async function triggerAutoHealer() {
  console.log('[INFO] Triggering Auto-Healer manually...\n')
  ...
  try {
    ...
    console.log('[OK] Auto-Healer triggered successfully!')
    console.log('Event IDs:', result.ids)
    console.log('\n[INFO] The worker will now:')
    ...
    console.log('\n[INFO] Check Inngest dashboard or logs for execution details')
  } catch (error) {
    console.error('[ERROR] Error triggering Auto-Healer:', error)
    process.exit(1)
  }
}
