    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        <div className="mb-8">
          <Link
            href="/deliberations"
            className="text-sm styles.colors.text.tertiary hover:styles.colors.text.primary"
          >
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6">
          <h1 className="text-2xl font-bold styles.colors.text.primary">
            Create New Deliberation
          </h1>
          <p className="mt-2 text-sm styles.colors.text.tertiary">
