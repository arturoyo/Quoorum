...
export function EmptyDebateState() {
  return (
    <div className="flex flex-1 w-full flex-col items-center justify-center bg-[#0b141a] text-center px-4">
      <div className="flex flex-col items-center justify-center gap-4 max-w-lg w-full">
        <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#202c33]">
