          ...
          <div className="mx-auto max-w-4xl space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Informe del Secretario del Tribunal</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center">
                  <div className="mb-2 text-3xl font-bold text-white">
                    {debate.finalSynthesis.debateQuality.convergenceScore}%
                  </div>
                  <div className="text-xs text-gray-400">Convergencia</div>
                  <div className="mt-2 h-2 w-full rounded-full bg-slate-700">
                    <div
                      className="h-full rounded-full bg-gradient-to-r from-purple-600 to-purple-400"
                      style={{ width: `${debate.finalSynthesis.debateQuality.convergenceScore}%` }}
                    />
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="mb-2 text-3xl font-bold text-white">
                    {debate.finalSynthesis.debateQuality.depthScore}%
                  </div>
                  <div className="text-xs text-gray-400">Profundidad</div>
                  <div className="mt-2 h-2 w-full rounded-full bg-slate-700">
                    <div
                      className="h-full rounded-full bg-gradient-to-r from-blue-600 to-blue-400"
                      style={{ width: `${debate.finalSynthesis.debateQuality.depthScore}%` }}
                    />
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="mb-2 text-3xl font-bold text-white">
                    {debate.finalSynthesis.debateQuality.diversityScore}%
                  </div>
                  ...
                  <div className="mt-2 h-2 w-full rounded-full bg-slate-700">
                    <div
                      ...
                      style={{ width: `${debate.finalSynthesis.debateQuality.diversityScore}%` }}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              {debate.finalSynthesis.top3Options.map((option: any, idx: number) => (
                <Card
                  key={idx}
                  className={cn(
                ...
                >
                  <div className="mb-3 flex items-start justify-between">
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-400 mb-3">{option.implementation}</p>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        {option.criticalRisks.map((risk: string, i: number) => (
            ...
            <Card className="border-purple-400/30 bg-gradient-to-br from-purple-600/20 to-blue-600/10 p-6">
              ...
              <div className="mb-4 rounded-lg bg-slate-900/60 p-4">
                <div className="mb-2 text-lg font-semibold text-purple-300">
                  {debate.finalSynthesis.recommendation.option}
                </div>
                <p className="text-gray-300 leading-relaxed">
                  {debate.finalSynthesis.recommendation.reasoning}
                </p>
              </div>
              ...
              <div>
                ...
                <ol className="space-y-2">
                  {debate.finalSynthesis.recommendation.nextSteps.map((step: string, idx: number) => (
