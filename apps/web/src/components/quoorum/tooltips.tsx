...
export function InfoTooltip({ content, maxWidth }: { content: string; maxWidth?: number }) {
  return (
    <Tooltip content={content} maxWidth={maxWidth}>
      <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-gray-200 text-gray-600 text-xs cursor-help">
        i
      </span>
    </Tooltip>
  )
    ...
    <Tooltip
      content={
        <div className="space-y-2">
          ...
          <div>
            <div className="text-gray-400 text-xs mb-1">Expertise:</div>
