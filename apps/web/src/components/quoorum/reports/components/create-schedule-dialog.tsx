...
import { type ReportFormat, type ReportType, type ScheduleFrequency, dayLabels } from '../types'

interface CreateScheduleDialogProps {
  onSuccess: () => void
}

type ScheduleReportType = Extract<
  ReportType,
  'weekly_summary' | 'monthly_summary' | 'expert_performance'
>
