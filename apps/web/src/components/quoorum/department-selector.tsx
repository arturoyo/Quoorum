    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A�ade contexto empresarial y departamental a tu debate
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg border border-dashed p-6 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Crea departamentos corporativos para debates m�s contextualizados
            </p>
            <Button
              className="mt-4"
          ...
          <div className="rounded-lg bg-blue-500/10 border border-blue-500/20 p-4">
            <div className="flex gap-2">
              ...
              <div className="space-y-1 text-sm">
                <p className="font-medium text-blue-400">�Qu� son los Departamentos Corporativos?</p>
                <p className="text-blue-300/80">
                  Son agentes especializados que debaten desde la perspectiva de cada �rea de tu empresa
                  (Finanzas, Marketing, Operaciones, etc.), inyectando el contexto espec�fico de tu organizaci�n.
                </p>
              </div>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="rounded-lg border border-dashed p-6 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Crea departamentos para debates m�s contextualizados
            </p>
            <Button
              className="mt-4"
              onClick={() => openSettings('/settings/company')}
      ...
      <CardContent className="space-y-4 max-h-[calc(100vh-300px)] overflow-y-auto">
        ...
        <div className="rounded-lg bg-blue-500/10 border border-blue-500/20 p-4">
          <div className="flex gap-2">
            <Info className="h-5 w-5 text-blue-400 flex-shrink-0" />
            <div className="space-y-1 text-sm">
              <p className="font-medium text-blue-400">Inyecci�n de Contexto (4 Capas)</p>
              <ul className="space-y-1 text-blue-300/80">
                <li>� <strong>Capa 1:</strong> Rol t�cnico del agente</li>
                <li>� <strong>Capa 2:</strong> Contexto de {company?.name || 'tu empresa'} (misi�n/visi�n/valores)</li>
