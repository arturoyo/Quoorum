...
export function UsageSection({ isInModal = false }: UsageSectionProps) {
  ...
  return (
    <div className={cn('space-y-6', isInModal ? 'pb-8' : 'pb-0')}>
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2 styles.colors.text.primary">Uso</h1>
      ...
      <Card className="relative overflow-hidden styles.colors.bg.secondary backdrop-blur-xl border-purple-500/20">
            ...
            <div className="flex items-center gap-2">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs styles.colors.bg.tertiary border-purple-500/30 styles.colors.text.primary">
                    <p className="text-sm">
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-purple-500/20">
                      <TableHead className="styles.colors.text.secondary">Detalles</TableHead>
                      <TableHead className="styles.colors.text.secondary">Fecha</TableHead>
                      <TableHead className="styles.colors.text.secondary text-right">Saldo antes</TableHead>
                      <TableHead className="styles.colors.text.secondary text-right">Créditos</TableHead>
                      <TableHead className="styles.colors.text.secondary text-right">Saldo después</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                            ...
                            <div>
                              ...
                              {transaction.debateStatus && (
                                <span className={cn(
                                  ...
                                  transaction.debateStatus === 'draft' ? 'bg-gray-500/20 styles.colors.text.secondary' :
                                  'bg-gray-500/20 styles.colors.text.secondary'
                                )}>
                                  {transaction.debateStatus}
                                </span>
                              )}
