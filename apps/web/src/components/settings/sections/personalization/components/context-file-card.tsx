...
export function ContextFileCard({
  ...
  return (
    <Card
      className={cn(
        'styles.colors.border.default styles.colors.bg.secondary backdrop-blur-xl hover:border-purple-500/30 transition-colors',
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <CardTitle className="styles.colors.text.primary flex items-center gap-2">
              ...
              {file.name}
              {!file.isActive && (
                <Badge variant="outline" className="styles.colors.border.default styles.colors.text.secondary styles.colors.bg.tertiary">
                  Inactivo
                </Badge>
              )}
            </CardTitle>
