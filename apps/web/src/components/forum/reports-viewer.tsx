...
function GenerateReportDialog({
  ...
  const generateDebateReport = api.forumReports.generateDebateReport.useMutation({
    onSuccess: () => {
  ...
  const generateWeeklySummary = api.forumReports.generateWeeklySummary.useMutation({
    onSuccess: () => {
  ...
  const generateCustomReport = api.forumReports.generateCustomReport.useMutation({
    onSuccess: () => {
...
function ShareDialog({
  ...
  const shareReport = api.forumReports.share.useMutation({
    onSuccess: () => {
  ...
  const shareUrl = shareToken
    ? `${window.location.origin}/forum/reports/shared/${shareToken}`
    : null
...
export function ReportsViewer({ debateId, showSchedules = true }: ReportsViewerProps) {
  ...
  } = api.forumReports.list.useQuery({ limit: 50 })

  const {
    data: schedules,
    isLoading: loadingSchedules,
    refetch: refetchSchedules,
  } = api.forumReports.listSchedules.useQuery()

  const deleteReport = api.forumReports.delete.useMutation({
    onSuccess: () => {
  ...
  const updateSchedule = api.forumReports.updateSchedule.useMutation({
    onSuccess: () => {
  ...
  const deleteSchedule = api.forumReports.deleteSchedule.useMutation({
    onSuccess: () => {
  ...
  const runScheduleNow = api.forumReports.runScheduleNow.useMutation({
    onSuccess: () => {
