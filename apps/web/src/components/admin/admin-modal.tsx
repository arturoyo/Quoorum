...
export function AdminModal({ open, onOpenChange, initialSection }: AdminModalProps) {
  ...
  if (isChecking || isLoadingUser) {
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-7xl max-h-[95vh] overflow-hidden styles.colors.bg.primary border-purple-500/20">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-7xl max-h-[95vh] overflow-hidden styles.colors.bg.primary border-purple-500/20 p-0">
